...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      {/* Analytics CTA */}
      <div className="mb-8 bg-gradient-to-r from-zinc-900 to-zinc-700 rounded-xl p-5 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-white font-semibold text-sm">Thống kê & Báo cáo chi tiết</p>
            <p className="text-zinc-400 text-xs mt-0.5">Phân tích doanh thu, phim, rạp, khách hàng, F&B với bộ lọc ngày linh hoạt và xuất CSV</p>
          </div>
        </div>
        <Link href="/admin/analytics" className="flex-shrink-0 flex items-center gap-2 px-4 py-2 bg-white text-zinc-900 text-sm font-medium rounded-lg hover:bg-zinc-100 transition-colors">
          Xem thống kê
