    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Admin endpoints - accessible by all admin roles (fine-grained via @PreAuthorize)
                .requestMatchers("/api/admin/**").hasAnyRole("ADMIN", "MANAGER", "STAFF", "TECHNICIAN")
                .requestMatchers(HttpMethod.POST, "/api/cities/**").hasAnyRole("ADMIN", "MANAGER")
                ...
                .requestMatchers(HttpMethod.PUT, "/api/showtimes/**").hasAnyRole("ADMIN", "MANAGER")
                .requestMatchers(HttpMethod.DELETE, "/api/showtimes/**").hasAnyRole("ADMIN", "MANAGER")
