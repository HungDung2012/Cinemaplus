...
public final class PermissionConstants {
    ...
    static {
        ...
        // MANAGER: quản lý lịch chiếu, rạp, phòng, kho F&B, booking, khuyến mãi, báo cáo chi nhánh
        ...
        // STAFF: bán vé, tạo booking (không xóa, không sửa giá)
        ROLE_PERMISSIONS.put(User.Role.STAFF, Set.of(
            CREATE_BOOKING, CHECK_IN_TICKET,
            MANAGE_BOOKINGS,
            VIEW_DASHBOARD
        ));

        // TECHNICIAN: chỉ soát vé
        ROLE_PERMISSIONS.put(User.Role.TECHNICIAN, Set.of(
            CHECK_IN_TICKET,
            VIEW_DASHBOARD
        ));
    ...
    public static Set<User.Role> getAdminRoles() {
        return Set.of(User.Role.ADMIN, User.Role.MANAGER, User.Role.STAFF, User.Role.TECHNICIAN);
    }
}
