        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Hệ thống đặt vé xem phim trực tuyến hàng đầu Việt Nam. Trải nghiệm điện ảnh tuyệt vời cùng CinemaPlus.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link href="/movies?tab=coming-soon" className="hover:text-red-500 transition-colors">
                  Phim sắp chiếu
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>support@cinemaplus.vn</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
